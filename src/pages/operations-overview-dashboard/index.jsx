              ...
              <div className="bg-blue-50 rounded-lg shadow p-4 min-w-[220px] border border-blue-200">
                ...
                <table className="w-full text-sm">
                  <tbody>
                    ...
                    <tr><td className="py-1 font-semibold text-gray-700">Inventory Total</td><td className="py-1 text-right">{displayRows.reduce((sum, item) => sum + (item.total_amount || 0), 0).toFixed(2)}</td></tr>
                    <tr><td className="py-1 font-semibold text-gray-700">Wash &amp; Dry Total</td><td className="py-1 text-right">{displayTickets.reduce((sum, ticket) => sum + (ticket.total_amount || 0), 0).toFixed(2)}</td></tr>
