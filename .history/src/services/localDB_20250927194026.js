class LocalDB {
  ...
  async initializeDB() {
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (event) => {
        ...
        // Create object store for active sessions
  ...
  // Get or create active session for employee
  async getActiveSession(employeeId) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = (event) => {
        console.error('Error getting active session:', event.target.error);
  ...
  async getUnsyncedSessions() {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = (event) => {
        console.error('Error getting unsynced sessions:', event.target.error);
        reject(event.target.error);
      };
    });
  }
